  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', width: '100%', minWidth: 0, boxSizing: 'border-box', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div style={{
        ...
        {/* Right Status Indicators matching reference */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px', zIndex: 2 }}>
          <div style={{ textAlign: 'right' }}>
            ...
            <div style={{ fontSize: '12.5px', fontWeight: '700', color: '#0284C7', display: 'flex', alignItems: 'center', gap: '6px', justifyContent: 'flex-end', marginTop: '2px' }}>
              <span style={{ width: '7px', height: '7px', borderRadius: '50%', backgroundColor: '#0284C7', boxShadow: '0 0 6px #38BDF8' }} />
              Connected & Synced
            </div>
          </div>
          ...
          <div style={{ textAlign: 'right' }}>
            ...
            <div style={{ fontSize: '12.5px', fontWeight: '800', color: '#16A34A', display: 'flex', alignItems: 'center', gap: '6px', justifyContent: 'flex-end', marginTop: '2px' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flexWrap: 'wrap' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '12px', color: '#1E3A8A', fontWeight: '700' }}>
            <Filter size={14} style={{ color: '#0E7490' }} />
            <span>Dashboard Filters:</span>
          </div>

          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <span style={{ fontSize: '11px', color: '#64748B', fontWeight: '600' }}>Executive</span>
            <select
              value={selectedExecutive}
              onChange={(e) => setSelectedExecutive(e.target.value)}
              style={{ height: '30px', borderRadius: '8px', border: '1px solid #CBD5E1', padding: '0 8px', fontSize: '12px', fontWeight: '600', color: '#1E293B', backgroundColor: '#FFFFFF' }}
            >
              <option value="Manojraj">Manojraj (Sales Exec)</option>
              <option value="Vijay">Vijay (Sales Head)</option>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <span style={{ fontSize: '11px', color: '#64748B', fontWeight: '600' }}>Region</span>
            <select
        ...
        >
          <RefreshCw size={12} className={isRefreshing ? 'animate-spin' : ''} style={{ color: '#0E7490' }} />
          <span>Sync Data</span>
        </button>
      </div>

      {/* ROW 1: 5-COLUMN KPI CARDS (MATCHING REFERENCE DESIGN) */}
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '16px', width: '100%' }}>
        ...
        <div className="section-card" style={{ padding: '16px 18px', backgroundColor: '#FFFFFF', border: '1px solid #EAEFEF', borderRadius: '16px', display: 'flex', flexDirection: 'column', gap: '8px', boxShadow: '0 4px 18px rgba(15, 23, 42, 0.03)' }}>
          <span style={{ fontSize: '11px', fontWeight: '800', color: '#1E3A8A', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Calls Completed</span>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
      ...
      {/* ROW 2: MONTH TARGET RUN RATE & SALES FUNNEL (BALANCED 50/50 SPLIT) */}
        ...
        <div className="section-card" style={{ padding: '16px 20px', backgroundColor: '#FFFFFF', border: '1px solid #EAEFEF', borderRadius: '16px', display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'space-between', boxShadow: '0 4px 18px rgba(15, 23, 42, 0.03)' }}>
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #F1F5F9', paddingBottom: '8px', marginBottom: '12px' }}>
              ...
              <span style={{ fontSize: '10.5px', fontWeight: '700', color: '#166534', backgroundColor: '#DCFCE7', border: '1px solid #BBF7D0', padding: '2px 8px', borderRadius: '10px' }}>
                PACING: 96% ON TRACK
              </span>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', textAlign: 'center', marginBottom: '14px' }}>
              <div style={{ backgroundColor: '#F8FAFC', padding: '10px 8px', borderRadius: '10px', border: '1px solid #E2E8F0' }}>
                ...
                <strong style={{ fontSize: '17px', color: '#0F172A', fontWeight: '900' }}>₹ 75.0 L</strong>
              </div>
              <div style={{ backgroundColor: '#F0FDF4', padding: '10px 8px', borderRadius: '10px', border: '1px solid #BBF7D0' }}>
                ...
                <strong style={{ fontSize: '17px', color: '#16A34A', fontWeight: '900' }}>₹ 72.0 L</strong>
              </div>
              <div style={{ backgroundColor: '#FFFBEB', padding: '10px 8px', borderRadius: '10px', border: '1px solid #FDE68A' }}>
                ...
                <strong style={{ fontSize: '17px', color: '#D97706', fontWeight: '900' }}>₹ 3.0 L</strong>
              </div>
            </div>
      ...
      {/* ROW 3: SALES TREND, PRODUCT PERFORMANCE, TOP 10 CUSTOMERS (3-COLUMN BALANCED) */}
      ...
      {/* ROW 4: FOLLOW-UP AND OPPORTUNITY LIST (FULL WIDTH TABLE WITH SPACIOUS PADDING) */}
      ...
      {/* ROW 5: CUSTOMER OUTSTANDING & CREDIT + LOST / CANCELLED (BALANCED 50/50 SPLIT MATCHING REFERENCE ROW 2) */}
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', width: '100%', alignItems: 'stretch' }}>
      ...
      {/* ROW 6: ACTIVITY SUMMARY & OPPORTUNITY RISK (BALANCED 50/50 SPLIT) */}
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', width: '100%', alignItems: 'stretch' }}>
      ...
      {/* ROW 7: TODAY'S SNAPSHOT RIBBON (CLEAN WHITE CARD MATCHING REFERENCE BOTTOM RIBBON) */}
      <div className="section-card" style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(8, 1fr)', gap: '10px', textAlign: 'center' }}>
          <div style={{ backgroundColor: '#F8FAFC', border: '1px solid #F1F5F9', padding: '10px 8px', borderRadius: '10px' }}>
            ...
            <strong style={{ fontSize: '18px', color: '#1E293B', fontWeight: '800' }}>34</strong>
          </div>
          <div style={{ backgroundColor: '#F8FAFC', border: '1px solid #F1F5F9', padding: '10px 8px', borderRadius: '10px' }}>
            <span style={{ fontSize: '10.5px', color: '#64748B', display: 'block', fontWeight: '600' }}>Outgoing calls</span>
            <strong style={{ fontSize: '18px', color: '#1E293B', fontWeight: '800' }}>142</strong>
          </div>
          <div style={{ backgroundColor: '#F8FAFC', border: '1px solid #F1F5F9', padding: '10px 8px', borderRadius: '10px' }}>
            <span style={{ fontSize: '10.5px', color: '#64748B', display: 'block', fontWeight: '600' }}>Incoming calls</span>
            <strong style={{ fontSize: '18px', color: '#1E293B', fontWeight: '800' }}>44</strong>
          </div>
          <div style={{ backgroundColor: '#F8FAFC', border: '1px solid #F1F5F9', padding: '10px 8px', borderRadius: '10px' }}>
            <span style={{ fontSize: '10.5px', color: '#64748B', display: 'block', fontWeight: '600' }}>Meetings</span>
            <strong style={{ fontSize: '18px', color: '#1E293B', fontWeight: '800' }}>28</strong>
          </div>
          <div style={{ backgroundColor: '#F8FAFC', border: '1px solid #F1F5F9', padding: '10px 8px', borderRadius: '10px' }}>
            <span style={{ fontSize: '10.5px', color: '#64748B', display: 'block', fontWeight: '600' }}>Offers sent</span>
            <strong style={{ fontSize: '18px', color: '#1E293B', fontWeight: '800' }}>36</strong>
          </div>
          <div style={{ backgroundColor: '#F8FAFC', border: '1px solid #F1F5F9', padding: '10px 8px', borderRadius: '10px' }}>
            <span style={{ fontSize: '10.5px', color: '#64748B', display: 'block', fontWeight: '600' }}>Proforma invoices</span>
            <strong style={{ fontSize: '18px', color: '#0284C7', fontWeight: '800' }}>18</strong>
          </div>
          <div style={{ backgroundColor: '#F8FAFC', border: '1px solid #F1F5F9', padding: '10px 8px', borderRadius: '10px' }}>
            <span style={{ fontSize: '10.5px', color: '#64748B', display: 'block', fontWeight: '600' }}>Invoice value</span>
            <strong style={{ fontSize: '18px', color: '#EA580C', fontWeight: '800' }}>₹ 68.5 L</strong>
          </div>
          <div style={{ backgroundColor: '#F8FAFC', border: '1px solid #F1F5F9', padding: '10px 8px', borderRadius: '10px' }}>
            <span style={{ fontSize: '10.5px', color: '#64748B', display: 'block', fontWeight: '600' }}>Collections</span>
            <strong style={{ fontSize: '18px', color: '#16A34A', fontWeight: '800' }}>₹ 54.2 L</strong>
          </div>
        </div>
      </div>
