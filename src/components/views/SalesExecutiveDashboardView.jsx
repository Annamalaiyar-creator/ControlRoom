    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', width: '100%', minWidth: 0, boxSizing: 'border-box', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px', zIndex: 2 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <span style={{ fontSize: '22px', fontWeight: '900', letterSpacing: '1px', color: '#38BDF8', fontFamily: 'monospace' }}>VRM</span>
                <span style={{ fontSize: '13px', fontWeight: '700', color: '#94A3B8', letterSpacing: '0.5px' }}>VRM STRUCTURES INDIA PVT. LTD.</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginTop: '4px' }}>
                <h1 style={{ fontSize: '24px', fontWeight: '800', margin: 0, color: '#FFFFFF', letterSpacing: '-0.02em' }}>
                  MY SALES DASHBOARD
                </h1>
                <span style={{ fontSize: '12px', fontWeight: '700', color: '#F59E0B', backgroundColor: 'rgba(245, 158, 11, 0.15)', border: '1px solid rgba(245, 158, 11, 0.3)', padding: '2px 10px', borderRadius: '20px' }}>
                  Focus • Follow-up • Convert
                </span>
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
              <span style={{ fontSize: '10px', fontWeight: '700', color: '#94A3B8', textTransform: 'uppercase' }}>Sales Executive</span>
              <select
              ...
              >
                <option value="Manojraj">Manojraj (Self)</option>
            ...
            {/* Period Selector */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
              <span style={{ fontSize: '10px', fontWeight: '700', color: '#94A3B8', textTransform: 'uppercase' }}>Period</span>
              <select
            ...
            {/* Region Selector */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
              <span style={{ fontSize: '10px', fontWeight: '700', color: '#94A3B8', textTransform: 'uppercase' }}>Region</span>
              <select
              ...
              >
                ...
                <option value="South">South (TN, KA, AP)</option>
                <option value="West">West (GJ, MH)</option>
                <option value="North">North (DL, HR, UP)</option>
              </select>
            </div>

            {/* Product Selector */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
              <span style={{ fontSize: '10px', fontWeight: '700', color: '#94A3B8', textTransform: 'uppercase' }}>Product</span>
              <select
              ...
              >
                ...
                <option value="BOS Kits">BOS Kits</option>
                <option value="Walkway">Walkway / Handrail</option>
            ...
            <button
              ...
              title="Sync latest Zoho CRM & Books data"
              style={{
                marginTop: '16px',
                height: '34px',
                width: '34px',
        ...
        <div style={{
          ...
          <div>
            <span>My CRM activity: </span>
            <strong style={{ color: '#E2E8F0' }}>offers, opportunities and follow-ups</strong>
            <span style={{ margin: '0 8px', color: '#475569' }}>|</span>
            <span>Zoho Books: </span>
            <strong style={{ color: '#E2E8F0' }}>invoices, customers and collections</strong>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#38BDF8', fontWeight: '700' }}>
            ...
            Zoho Books synced: Today 09:30 AM
          </div>
        </div>
      </div>
